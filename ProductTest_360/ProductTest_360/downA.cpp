...
void downA::on_pushButton_clicked()
{
	...
	writeCSV(snInf, NULL, "PASS", QString::number(2), currentTime, QString::fromLocal8Bit("关机漏电流"), NULL, NULL, NULL, NULL, NULL);
	this->close();
...
void downA::on_pushButton_3_clicked()
{
	...
	QDateTime time;
	QString currentTime = time.currentDateTime().toString("yyyy/MM/dd HH:mm:ss");
	writeCSV(snInf, NULL, "FAIL", QString::number(2), currentTime, QString::fromLocal8Bit("关机漏电流"), NULL, NULL, NULL, NULL, NULL);
	this->close();
