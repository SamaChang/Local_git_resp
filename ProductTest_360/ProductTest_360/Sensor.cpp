...
void Sensor::on_pushButton_clicked()
{
	...
	writeCSV(snInf, NULL, "PASS", QString::number(7), currentTime, QString::fromLocal8Bit("光感测试"), NULL, NULL, NULL, NULL, NULL);
	this->close();
...
void Sensor::on_pushButton_2_clicked()
{
	...
	QString currentTime = time.currentDateTime().toString("yyyy/MM/dd HH:mm:ss");
	recordResult("FAIL");
	writeCSV(snInf, NULL, "FAIL", QString::number(7), currentTime, QString::fromLocal8Bit("光感测试"), NULL, NULL, NULL, NULL, NULL);
	this->close();
