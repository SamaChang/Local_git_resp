...
void LED::on_pushButton_clicked()
{
	...
	writeCSV(snInf, NULL, "PASS", QString::number(5), currentTime, QString::fromLocal8Bit("LED"), NULL, NULL, NULL, NULL, NULL);
	this->close();
...
void LED::on_pushButton_2_clicked()
{
	...
	QString currentTime = time.currentDateTime().toString("yyyy/MM/dd HH:mm:ss");
	recordResult("FAIL");
	writeCSV(snInf, NULL, "FAIL", QString::number(5), currentTime, QString::fromLocal8Bit("LED"), NULL, NULL, NULL, NULL, NULL);
	this->close();
