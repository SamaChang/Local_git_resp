...
void MicAndSpeaker::on_pushButton_clicked()
{
	...
	writeCSV(snInf, NULL, "PASS", QString::number(12), currentTime, QString::fromLocal8Bit("Mic/Speaker"), NULL, NULL, NULL, NULL, NULL);
	this->close();
...
void MicAndSpeaker::on_pushButton_2_clicked()
{
	...
	QString currentTime = time.currentDateTime().toString("yyyy/MM/dd HH:mm:ss");
	recordResult("FAIL");
	writeCSV(snInf, NULL, "FAIL", QString::number(12), currentTime, QString::fromLocal8Bit("Mic/Speaker"), NULL, NULL, NULL, NULL, NULL);
	this->close();
