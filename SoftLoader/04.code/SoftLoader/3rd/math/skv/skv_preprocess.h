...
extern "C" {
	...
	#define FRAME_SIZE 4096				/* The number of sample in a frame */
	...
	*/
	int skv_preprocess_state_init(int sampling_rate, int bits_persample, int num_src_channel);
	...
	*/
	...
	//hc自定义函数
	int skv_preprocess_byte_hc(BYTE * in, COMPLEX_OUT * out, int in_size,int bigOrlittle);
