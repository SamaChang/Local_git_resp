...
public:
    ...
    void setupUi(QWidget *FlashWgt)
    {
        ...
        FlashWgt->resize(1135, 701);
        verticalLayout_2 = new QVBoxLayout(FlashWgt);
        verticalLayout_2->setSpacing(6);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        widget = new QWidget(FlashWgt);
        ...
        pushButton_1->setMinimumSize(QSize(100, 28));

        horizontalLayout->addWidget(pushButton_1);

        pushButton_2 = new QPushButton(widget_2);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setMinimumSize(QSize(100, 28));

        horizontalLayout->addWidget(pushButton_2);

        pushButton_3 = new QPushButton(widget_2);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setMinimumSize(QSize(100, 28));
    ...
    void retranslateUi(QWidget *FlashWgt)
    {
        ...
        checkBox->setText(QCoreApplication::translate("FlashWgt", "\345\212\240\345\257\206", nullptr));
    } // retranslateUi
