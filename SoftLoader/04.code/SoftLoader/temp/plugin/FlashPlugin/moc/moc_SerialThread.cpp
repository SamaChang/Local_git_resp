...
#include <memory>
#include "../../../../FlashPlugin/SerialThread.h"
...
QT_MOC_LITERAL(12, 106, 19), // "sig_thread_finished"
QT_MOC_LITERAL(13, 126, 14), // "slot_init_port"
QT_MOC_LITERAL(14, 141, 10), // "slot_start"
QT_MOC_LITERAL(15, 152, 16), // "slot_handle_data"
QT_MOC_LITERAL(16, 169, 15), // "slot_write_data"
QT_MOC_LITERAL(17, 185, 13) // "erase_process"

    },
    "SerialThread\0sig_status\0\0BURN_STATE\0"
    "nState\0nVal\0sig_log\0strLog\0thread_sig\0"
    "run_erase\0next_erase\0next_write\0"
    "sig_thread_finished\0slot_init_port\0"
    "slot_start\0slot_handle_data\0slot_write_data\0"
    "erase_process"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->sig_thread_finished(); break;
        case 8: _t->slot_init_port(); break;
        case 9: _t->slot_start(); break;
        case 10: _t->slot_handle_data(); break;
        case 11: _t->slot_write_data(); break;
        case 12: _t->erase_process(); break;
        default: ;
        }
        ...
        {
            using _t = void (SerialThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialThread::sig_thread_finished)) {
                *result = 7;
                return;
            }
        }
...
// SIGNAL 7
void SerialThread::sig_thread_finished()
{
